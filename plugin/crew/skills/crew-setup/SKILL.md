...
```json
{
  ...
  "verifyGate": true,
  "context": { "enabled": true, "warnAt": 0.8, "budgetTokens": null, "reserveTokens": 100000, "handoffPath": ".work/HANDOFF.md", "keepTranscripts": 5, "autoClear": { "enabled": false, "method": "auto", "windowTitle": null, "command": "/clear", "delaySeconds": 3, "minHandoffLines": 5 }, "autoWrapUp": false, "autoResume": false, "staleHandoff": { "maxAgeHours": 72, "maxCommitsBehind": 3 } },
