...
`git ls-files 'plugin/crew/*.md'` currently totals 29,194 lines across 176 files (including this
...
- **Held** (`.budget-allowance.json`, reason `held: awaiting owner decision on T2 deletions`):
  ...
  Landing those deletions alone takes the total to roughly 17,819 lines.
...
Even both together (≈16,313 lines) stay nowhere near 6,000. The rest of the reduction is guide
