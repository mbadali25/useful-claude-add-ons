...
# `crew_freshness` was split off on 2026-09-14 for the same reason and under
# the same rule: `.pylintrc`'s comment says the third raise must be a split,
# and this file was one line under the ceiling. See its docstring for the
# seam.
#
# Unlike the block above, THREE of the names below are called in this module
# -- `contained_path` by `handoff_path`, and `read_knowledge` and
# `read_diagrams` by `collect`. Those three carry no suppression, because they
# are ordinary imports that happen also to be re-exported; the rest are
# re-exports only and are marked per name, exactly as the guards block is.
from crew_freshness import (
    DIAGRAMS_DIR_DEFAULT,  # noqa: F401
    DIAGRAM_KINDS,  # noqa: F401
    GRAPH_NONCODE_PATHS,  # noqa: F401
    GRAPH_OUT_DEFAULT,  # noqa: F401
    _ANCHOR_RE,  # noqa: F401
    _BUILT_AT_RE,  # noqa: F401
    _CITED_PATH_RE,  # noqa: F401
    _DIAGRAM_ANCHORS_RE,  # noqa: F401
    _DIAGRAM_ANCHOR_RE,  # noqa: F401
    _DIAGRAM_EXTS,  # noqa: F401
    _GRAPH_TAIL_BYTES,  # noqa: F401
    _NOT_SUBSYSTEMS,  # noqa: F401
    _built_at_commit,  # noqa: F401
    _cited_paths,  # noqa: F401
    _diagram_paths,  # noqa: F401
    _diagrams_dir,  # noqa: F401
    _moved_since,  # noqa: F401
    _read_graph,  # noqa: F401
    contained_path,
    read_diagrams,
    read_knowledge,
)
...
def main(argv=None):
    ...
    if args.record_scan_artifact:
        ...
        if isinstance(path, dict):
            # A lock that could not be taken or a failed write
            # (crew_endpoints, BLOCK 6) -- never printed as if the freeze
            # had landed.
