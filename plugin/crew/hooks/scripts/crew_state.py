...
# The endpoint ledger is its own module now, and the three shared readers
# are a third. Both import lines re-export as well as import: `crew_config`,
# `pm_brief` and `crew_upgrade` reach `read_text`, `git_out` and
# `dict_or_empty` through `crew_state`, and that spelling keeps working.
