...
|---|---|
| **Source** | [`crew/`](crew) |
| **Version** | 0.20.10<!-- claim: plugin-version:crew --> |
...
| **Registers** | 54 agents, 28 commands, 20 skills<!-- claim: plugin-skills:crew -->, 20 hook entries (10 scripts × `.sh`/`.ps1`) across 5 events |
...
| **Version** | 0.3.14<!-- claim: plugin-version:obsidian-vault --> |
