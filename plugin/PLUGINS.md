...
|---|---|
| **Source** | [`crew/`](crew) |
| **Version** | 0.19.80<!-- claim: plugin-version:crew --> |
...
| **Registers** | 54 agents, 28 commands, 20 skills<!-- claim: plugin-skills:crew -->, 18 hook entries (9 scripts × `.sh`/`.ps1`) across 5 events |
