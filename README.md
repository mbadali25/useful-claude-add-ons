...
No standalone skills added this round. The 28 skills registered in
...
| [`report-builder`](skills/report-builder) | Docs / Reporting | Human-facing reports authored as HTML and converted to DOCX/PDF through Word - branded masthead, plain-language lede, summary cards, findings table with severity chips, and the exact CSS Word's parser silently drops. | "Make this a PDF"; "write this up for management"; a generated DOCX that came out unstyled black-on-white; choosing severity colours; deciding whether something is one report or a summary plus a detail report. | Automatic |
