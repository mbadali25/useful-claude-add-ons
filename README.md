...
```powershell
irm 'https://raw.githubusercontent.com/mbadali25/useful-claude-add-ons/02c08a446dfcabf25805908823c5b3381f5a3a8e/scripts/install-prerequisites.ps1' | iex
```

**Linux**:

```bash
curl -fsSL 'https://raw.githubusercontent.com/mbadali25/useful-claude-add-ons/02c08a446dfcabf25805908823c5b3381f5a3a8e/scripts/install-prerequisites.sh' | bash
```
