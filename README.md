...
```powershell
irm 'https://raw.githubusercontent.com/mbadali25/useful-claude-add-ons/5d1fc5fd8b08cbfff639de25bf69359125d335d1/scripts/install-prerequisites.ps1' | iex
```

**Linux**:

```bash
curl -fsSL 'https://raw.githubusercontent.com/mbadali25/useful-claude-add-ons/5d1fc5fd8b08cbfff639de25bf69359125d335d1/scripts/install-prerequisites.sh' | bash
```
