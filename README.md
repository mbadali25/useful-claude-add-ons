...
```powershell
irm 'https://raw.githubusercontent.com/mbadali25/useful-claude-add-ons/a8a511fa39a8f864a48e69294774c1d30a280a65/scripts/install-prerequisites.ps1' | iex
```

**Linux**:

```bash
curl -fsSL 'https://raw.githubusercontent.com/mbadali25/useful-claude-add-ons/a8a511fa39a8f864a48e69294774c1d30a280a65/scripts/install-prerequisites.sh' | bash
```
