...
```powershell
irm 'https://raw.githubusercontent.com/mbadali25/useful-claude-add-ons/d914aeb8e096c1c5dc6ca5191df411c005bbabe5/scripts/install-prerequisites.ps1' | iex
```

**Linux**:

```bash
curl -fsSL 'https://raw.githubusercontent.com/mbadali25/useful-claude-add-ons/d914aeb8e096c1c5dc6ca5191df411c005bbabe5/scripts/install-prerequisites.sh' | bash
```
