...
$script:Catalog = @(
    ...
    [pscustomobject]@{ Key = 'repo-plugins';      Default = $false; Name = "This repo's plugins: crew, gizmoduck, localgpu, obsidian-vault, rule-of-two (agents, hooks)" }
...
$script:PluginCatalog = @(
    [pscustomobject]@{ Key = 'crew'; Selected = $true; Name = 'crew                    - Virtual dev team: 54 agents, 26 commands, safety hooks'; Spec = 'crew@useful-claude-add-ons|mbadali25/useful-claude-add-ons|useful-claude-add-ons' }
    ...
    [pscustomobject]@{ Key = 'rule-of-two'; Selected = $true; Name = 'rule-of-two              - Two-family adversarial review of agents, skills, plugins. No hooks'; Spec = 'rule-of-two@useful-claude-add-ons|mbadali25/useful-claude-add-ons|useful-claude-add-ons' }
)
