...
# "1 of 4": the repo-plugins catalog now has four entries (crew, gizmoduck,
# localgpu, obsidian-vault) - --plugins crew narrows the *selection*, not the
# catalog, exactly like --team below narrows selection within its own
# fixed-size catalog.
case "$out" in *"This repo's plugins: 1 of 4"*) got=yes ;; *) got=no ;; esac
