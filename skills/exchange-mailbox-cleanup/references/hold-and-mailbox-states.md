...
Shared by `exchange-mailbox-cleanup` and `exchange-mailbox-restore`. Read this whenever a hold
...
then resolves to the *wrong* mailbox without error. Record the GUID the first time you see it and
