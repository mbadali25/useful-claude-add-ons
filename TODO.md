...
- `check-marketplace.py` fails on crew-1.0: "obsidian-vault: plugin/obsidian-vault/ has changed since version 0.4.2 was set (a11d25e6 2026-09-23)". Merging `crew-1.0-T7-drainfix2` (35476f6c) changed the plugin after 0.4.2 was registered. 0.4.2 is not on main (main has 0.3.16), so no installed copy is stale, but the gate is red until the owner bumps to 0.4.3 or re-registers 0.4.2 in a later commit. Kept at 0.4.2 per the integration brief.
