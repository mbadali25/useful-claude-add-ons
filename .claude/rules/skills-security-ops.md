...
paths:
  ...
  - "skills/cisco-meraki/**"
---
<!-- crew:generated source=.crew/codemap/skills-security-ops.md sha256=72c4fd959bf19057 -- do not hand-edit; regenerate with crew_instructions.py rules -->
# skills-security-ops
Code map anchor `bc6a3a09`; if it is behind HEAD, re-check with `git diff --name-only bc6a3a09..HEAD -- <cited paths>`.
