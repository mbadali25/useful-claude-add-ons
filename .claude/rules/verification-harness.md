...
---
<!-- crew:generated source=.crew/codemap/verification-harness.md sha256=4e4402df4b7fb090 -- do not hand-edit; regenerate with crew_instructions.py rules -->
...
- `.crew/verify.json:263-273` (rule 24) — the T-0006 auto-resume suite; `plugin/crew/tests/sabotage.py:76`, `:3048` — `sabotage_resume.py`'s registration.
...
- `plugin/crew/hooks/scripts/verify-gate.sh:1493-1502` / `plugin/crew/CONFIG.md:2016-2023` — the descoped per-rule process-group kill, documented as a standing limitation.
