...
- `plugin/crew/hooks/scripts/crew_config.py:239` / `:372` — `default_config()` / `default_global_config()`.
- `plugin/crew/hooks/scripts/crew_config.py:2351` — `_RATCHETED`, the 13-key ratchet table (five construction steps).
