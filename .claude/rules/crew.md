...
paths:
  - "plugin/crew/**"
---
<!-- crew:generated source=.crew/codemap/crew.md sha256=6af922450258d18b -- do not hand-edit; regenerate with crew_instructions.py rules -->
# crew
...
- `plugin/crew/hooks/scripts/crew_refresh_check.py:549` — `ticket_freshness`, the library entry point; `main()` at `:645`.
