...
- `plugin/crew/hooks/scripts/crew_config.py:239` / `:378` — `default_config()` / `default_global_config()`.
- `plugin/crew/hooks/scripts/crew_config.py:2357` — `_RATCHETED`, the 13-key ratchet table (five construction steps).
